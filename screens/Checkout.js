...
export function Checkout(params) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ImageBackground source={require('../assets/dress 2.jpg')} style={styles.bgImage}>
        <View style={styles.mainContainer}>
          ...
          <TouchableOpacity onPress={checkInput} style={styles.continueBtn}>
            <Text style={{ fontWeight: "bold", fontSize: 17, backgroundColor: 'green' }}>Continue to Payment info</Text>
          </TouchableOpacity>
        </View>
      </ImageBackground>
