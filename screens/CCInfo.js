...
export function CCInfo(params) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ImageBackground source={require('../assets/dress 3.jpg')} style={styles.bgImage}>
        <View style={styles.mainContainer}>
          ...
          <TouchableOpacity onPress={checkInput} style={styles.continueBtn}>
            <Text style={{ fontWeight: "bold", fontSize: 17, backgroundColor: 'green' }}>Complete checkout</Text>
          </TouchableOpacity>
        </View>
      </ImageBackground>
